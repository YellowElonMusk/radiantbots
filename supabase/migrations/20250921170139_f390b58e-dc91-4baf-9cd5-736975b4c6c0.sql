-- Database Schema Refactor for Marketplace App - CORRECT ORDER
...
-- Step 4: Drop existing RLS policies that depend on columns we'll change
...
-- Step 5: Clean up messages table first (remove invalid references)
...
-- Step 6: Update messages to use profile IDs instead of user IDs
...
-- Step 7: Restructure missions table
...
-- Step 9: Update profiles RLS policies
...
-- Step 10: Create new missions RLS policies
...
-- Step 11: Create new messages RLS policies  
...
-- Step 12: Clean up orphaned records
